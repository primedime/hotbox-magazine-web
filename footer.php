...
<div id="outdated">
    <h6><?php _e( 'Your browser is out-of-date!', 'hotbox-magazine' ); ?></h6>
    <p><?php _e( 'Update your browser to view this website correctly.', 'hotbox-magazine' ); ?> <a id="btnUpdateBrowser"
                                                                                            href="http://outdatedbrowser.com/"><?php _e( 'Update
			my browser now', 'hotbox-magazine' ); ?></a></p>
