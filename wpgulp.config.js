...
module.exports = {
	...
	// Project options.
	projectURL: 'HotBox Magazine.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'hotbox-magazine', // Your textdomain here.
	translationFile: 'hotbox-magazine', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'hotbox-magazine', // Package name.
